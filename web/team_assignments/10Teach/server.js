...
const connectionString =
  ...
  "postgres://elwihpozkimbmz:3d328ea38261b632db7ab7ae4292046963a1bb7bb2acb5c84dad1767cc15b1c7@ec2-107-21-102-221.compute-1.amazonaws.com:5432/d1bt2644oalhh2?ssl=true";
...
app.get("/getPersons", getPersonsFromDb);
...
function getPersonFromDb(id, callback) {
  ...
  const sql =
    "SELECT id, first, last, birthdate FROM person WHERE id = $1::int";
...
// By separating this out from the handler above, we can keep our model
// logic (this function) separate from our controller logic (the getPerson function)
function getPersonsFromDb(req, response) {
  const sql = "SELECT first, last FROM person";
